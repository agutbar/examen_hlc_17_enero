...
public class Etiqueta {
    ...
    @Column
    @NotNull(message = "El color debe ser rojo, azul, verde o amarillo")
    @Pattern(regexp= "^(Rojo|Azul|Verde|Amarillo)$")
    ...
    public Etiqueta(
            ...
            @NotNull(message = "El color debe ser rojo, azul, verde o amarillo") @Pattern(regexp= "^(rojo|azul|verde|amarillo)$") String color) {
        this.nombre = nombre;
    ...
    //Añadimos el get y el set del nuevo atributo
