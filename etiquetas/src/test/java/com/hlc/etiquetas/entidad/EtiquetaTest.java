...
class EtiquetaTest {
	   ...
	   void testConstructorConParametros() {
	        ...
	        Etiqueta etiqueta = new Etiqueta("Tarea urgente", "Etiqueta para tareas urgentes", true, 1, "Rojo");
	        ...
	        assertEquals("Rojo", etiqueta.getColor(), "El color no es el esperado");
	    }
	    ...
	    void testEstadoActivo() {
	        ...
	        Etiqueta etiqueta = new Etiqueta("Etiqueta activa", "Descripción", true, 2, "Amarillo");
	    ...
	    @Test
	    void testColor() {
	    	//Creamos una etiqueta de cada color valido y las comprobamos
	    	Etiqueta etiquetaAmarilla = new Etiqueta("Etiqueta amarilla", "Descripción", true, 2, "Amarillo");
	    	Etiqueta etiquetaRoja = new Etiqueta("Etiqueta roja", "Descripción", true, 2, "Rojo");
	    	Etiqueta etiquetaAzul = new Etiqueta("Etiqueta azul", "Descripción", true, 2, "Azul");
	    	Etiqueta etiquetaVerde = new Etiqueta("Etiqueta verde", "Descripción", true, 2, "Verde");
	    	assertTrue(etiquetaAmarilla.getColor().matches("^(Rojo|Azul|Verde|Amarillo)$"));
	    	assertTrue(etiquetaRoja.getColor().matches("^(Rojo|Azul|Verde|Amarillo)$"));
	    	assertTrue(etiquetaAzul.getColor().matches("^(Rojo|Azul|Verde|Amarillo)$"));
	    	assertTrue(etiquetaVerde.getColor().matches("^(Rojo|Azul|Verde|Amarillo)$"));
	    	
	    	//Ahora creamos una etiqueta con un color no valido y lo comprobamos
	    	Etiqueta etiquetaRosa = new Etiqueta("Etiqueta Rosa", "Descripción", true, 2, "Rosa");
	    	assertFalse(etiquetaRosa.getColor().matches("^(Rojo|Azul|Verde|Amarillo)$"));
	    }
