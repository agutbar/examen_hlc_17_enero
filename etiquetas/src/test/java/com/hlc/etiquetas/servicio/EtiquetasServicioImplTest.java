...
class EtiquetaServicioImplTest {
    ...
    void testGuardarEtiqueta() {
        Etiqueta etiqueta = new Etiqueta("Etiqueta 1", "Descripcion 1", true, 1, "Azul");
    ...
    void testObtenerEtiquetaPorId() {
        Etiqueta etiqueta = new Etiqueta("Etiqueta 1", "Descripcion 1", true, 1, "Amarillo");
        etiqueta.setId(1L);
    ...
    void testObtenerTodasLasEtiquetas() {
        List<Etiqueta> etiquetas = Arrays.asList(
                new Etiqueta("Etiqueta 1", "Descripcion 1", true, 1, "Rojo"),
                new Etiqueta("Etiqueta 2", "Descripcion 2", false, 3, "Azul")
        );
    ...
    void testActualizarEtiquetaSinDuplicados() {
        // Configuración del mock
        Long idEtiqueta = 1L;
        Etiqueta etiquetaExistente = new Etiqueta("Etiqueta Original", "Descripción Original", true, 1, "Azul");
        etiquetaExistente.setId(idEtiqueta);

        Etiqueta etiquetaActualizada = new Etiqueta("Etiqueta Actualizada", "Descripción Actualizada", false, 2, "Rojo");
